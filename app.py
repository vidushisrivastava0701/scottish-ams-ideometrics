...
st.markdown("""
    ...
    .stButton>button { background-color: #003262; color: white; width: 100%; border-radius: 4px; height: 3em; font-weight: bold; }
...
st.title("Scottish Antimicrobial Stewardship Strategy Engine")
...
if len(st.session_state.submitted_list) < len(interventions):
    ...
    # 1. Landing Page / Executive Summary (Only shows at Step 0)
    ...
    # Disable sliders if no ID is provided
